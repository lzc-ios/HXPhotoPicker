...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [[UIApplication sharedApplication] setStatusBarStyle:self.manager.configuration.isWXStyle?UIStatusBarStyleLightContent:self.manager.configuration.statusBarStyle];
